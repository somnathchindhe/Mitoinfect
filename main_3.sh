...
#################rm "ono_ratio_${cod1}_3_model_dnds.tsv" "ono_ratio_${cod2}_3_model_dnds.tsv" "free_ratio_${cod1}_3_model_dnds.tsv" "free_ratio_${cod2}_3_model_dnds.tsv" "two_ratio_${cod1}_3_model_dnds.tsv" "two_ratio_${cod2}_3_model_dnds.tsv"

# Create table files which store all dN/dS values and model parameters
echo -e "Ensembl_Gene_ID\tChlorocebus_sabaeus(w)\tNomascus_leucogenys(w)\tGorilla_gorilla(w)\tPan_troglodytes(w)\tPan_paniscus(w)\tHomo_sapiens(w)\tPongo_abelii(w)\tLikelihood(lnL)\tparameters(np)\tntime\tkappa(ts/tv)" > "free_ratio_${cod1}_3_model_dnds.tsv"
echo -e "Ensembl_Gene_ID\tChlorocebus_sabaeus(w)\tNomascus_leucogenys(w)\tGorilla_gorilla(w)\tPan_troglodytes(w)\tPan_paniscus(w)\tHomo_sapiens(w)\tPongo_abelii(w)\tLikelihood(lnL)\tparameters(np)\tntime\tkappa(ts/tv)" > "free_ratio_${cod2}_3_model_dnds.tsv"
echo -e "Ensembl_Gene_ID\tChlorocebus_sabaeus(w)\tNomascus_leucogenys(w)\tGorilla_gorilla(w)\tPan_troglodytes(w)\tPan_paniscus(w)\tHomo_sapiens(w)\tPongo_abelii(w)\tLikelihood(lnL)\tparameters(np)\tntime\tkappa(ts/tv)" > "two_ratio_${cod1}_3_model_dnds.tsv"
echo -e "Ensembl_Gene_ID\tChlorocebus_sabaeus(w)\tNomascus_leucogenys(w)\tGorilla_gorilla(w)\tPan_troglodytes(w)\tPan_paniscus(w)\tHomo_sapiens(w)\tPongo_abelii(w)\tLikelihood(lnL)\tparameters(np)\tntime\tkappa(ts/tv)" > "two_ratio_${cod2}_3_model_dnds.tsv"
echo -e "Ensembl_Gene_ID\tOmega(w)\tLikelihood(lnL)\tparameters(np)\tntime\tkappa(ts/tv)" > "ono_ratio_${cod1}_3_model_dnds.tsv"
echo -e "Ensembl_Gene_ID\tOmega(w)\tLikelihood(lnL)\tparameters(np)\tntime\tkappa(ts/tv)" > "ono_ratio_${cod2}_3_model_dnds.tsv"
...
echo -e "$id\t$cs11\t$nl11\t$gg11\t$pt11\t$pp11\t$hs11\t$pa11\t$lnL11\t$np11\t$ntime11\t$kappa11" >> "free_ratio_${cod1}_3_model_dnds.tsv" 
...
echo -e "$id\t$cs12\t$nl12\t$gg12\t$pt12\t$pp12\t$hs12\t$pa12\t$lnL12\t$np12\t$ntime12\t$kappa12" >> "free_ratio_${cod2}_3_model_dnds.tsv"  # create a table file containing dN/dS and other information
...
echo -e "$id\t$cs21\t$nl21\t$gg21\t$pt21\t$pp21\t$hs21\t$pa21\t$lnL21\t$np21\t$ntime21\t$kappa21" >> "two_ratio_${cod1}_3_model_dnds.tsv"
...
echo -e "$id\t$cs22\t$nl22\t$gg22\t$pt22\t$pp22\t$hs22\t$pa22\t$lnL22\t$np22\t$ntime22\t$kappa22" >> "two_ratio_${cod2}_3_model_dnds.tsv"
...
echo -e "$id\t$omega01\t$lnL01\t$np01\t$ntime01\t$kappa01" >> "ono_ratio_${cod1}_3_model_dnds.tsv" 
...
np02=$(grep "lnL" ${id}_${mod0}_${cod2}.out  |cut -f2 -d ":" | sed 's/ //g' | sed 's/np//g')
#echo -e "$id\t$omega02\t$lnL02\t$np02\t$ntime02\t$kappa02" >> "ono_ratio_${cod2}_3_model_dnds.tsv"
echo -e "$id\t$omega02\t$lnL02\t$np02\t$ntime02\t$kappa02" >> "ono_ratio_${cod2}_3_model_dnds.tsv"
