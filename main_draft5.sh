...
for id in $(cat ensemble_id.txt); do
...
mv "${id}_${mod0}_${cod1}.out" codeml_out/M0/F61/
mv "${id}_${mod1}_${cod1}.out" codeml_out/free_ratio/F61/
mv "${id}_${mod1}_${cod1}_raw_dnds.tre" codeml_out/free_ratio/F61/
mv "${id}_${mod2}_${cod1}.out" codeml_out/two_ratio/F61/
mv "${id}_${mod2}_${cod1}_raw_dnds.tre" codeml_out/two_ratio/F61/
mv "${id}_${mod0}_${cod2}.out" codeml_out/M0/F3X4/
mv "${id}_${mod1}_${cod2}.out" codeml_out/free_ratio/F3X4/
mv "${id}_${mod1}_${cod2}_raw_dnds.tre" codeml_out/free_ratio/F3X4/
mv "${id}_${mod2}_${cod2}.out" codeml_out/two_ratio/F3X4/
mv "${id}_${mod2}_${cod2}_raw_dnds.tre" codeml_out/two_ratio/F3X4/
